...
up=read.table(file="/psc/home/zihailing/zihailing/zhangxiaolan_20151204/venn/vein.up")
rownames(up) <-up$V1
up=rownames(up)
down=read.table(file="/psc/home/zihailing/zihailing/zhangxiaolan_20151204/venn/vein.down")
rownames(down) <-down$V1
down=rownames(down)
GO_up=TG(up)
GO_down=TG(down)
write.table(GO_up,"vein_GO_results/vein_up.go",sep="\t",col.names=T,row.names=F,quote=F)
write.table(GO_down,"vein_GO_results/vein_down.go",sep="\t",col.names=T,row.names=F,quote=F)
system("perl ~/zihailing/RNA_seq_script/Topgo_buqi.pl /psc/home/zihailing/zihailing/species_20151012/Ath/GO.terms_and_ids vein_GO_results/vein_up.go > vein_GO_results/vein_up.go.tmp ")
system("mv vein_GO_results/vein_up.go.tmp vein_GO_results/vein_up.go")
system("perl ~/zihailing/RNA_seq_script/Topgo_buqi.pl /psc/home/zihailing/zihailing/species_20151012/Ath/GO.terms_and_ids vein_GO_results/vein_down.go > vein_GO_results/vein_down.go.tmp ")
system("mv vein_GO_results/vein_down.go.tmp vein_GO_results/vein_down.go")

pdf("vein_GO_results/vein_up_go.pdf")
GR=read.table("vein_GO_results/vein_up.go",header=T,sep="\t",quote="")
GS=subset(GR,GR$pvalue<0.001)
write.table(GS,"vein_GO_results/vein_up.go.sig",sep="\t",col.names=T,row.names=F,quote=F)
...
pdf("vein_GO_results/vein_down_go.pdf")
GR=read.table("vein_GO_results/vein_down.go",header=T,sep="\t",quote="")
GS=subset(GR,GR$pvalue<0.001)
write.table(GS,"vein_GO_results/vein_down.go.sig",sep="\t",col.names=T,row.names=F,quote=F)
PV=as.numeric(GS$pvalue)
names(PV)= GS$Term
func=GS$catagory
GS$catagory=as.vector(GS$catagory)
